 ...
 * 
 */
public class FrameMenuPrincipalAnimado extends javax.swing.JFrame {
     ...
     */
    public FrameMenuPrincipalAnimado() throws Exception {
        initComponents();
        actualizarMenu();
        agregarPaneles();
        // **
    ...
    //--------------------------------------------------------------------------
    // Brqto: 09-04-2014. Este metodo NO funciono correctamente.
    //--------------------------------------------------------------------------
    private void agregarImagenFrame() throws Exception {
        MiImagen img = new MiImagen(); 
        //FireworksComponente img = new FireworksComponente();   // No funciona. (Brqto: 10-04-2014). 
        //img.setLocation(1, 1);
        img.setSize(400, 400);
        //img.setVisible(true);
        this.add(img); 
        //
        this.jDesktopPanel1.add(img);   // (Ok).
    }  // agregarImagenFrame(). 
    
    //--------------------------------------------------------------------------
    // Brqto: 10-04-2014. Este metodo NO funciono correctamente.
    //--------------------------------------------------------------------------
    private void agregarAnimacionFrame() throws Exception {
         MiClaseAnimado animado = new MiClaseAnimado(); 
        ...
        //this.add(animado); 
        //
        //this.jDesktopPanel1.add( (JComponent) animado);   // (Ok).
    }  // agregarImagenFrame(). 
    ...
    private void actualizarMenu() {
        ...
        this.jMenuItemSalir.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
                FrameMenuPrincipalAnimado.this.setVisible(false);
                FrameMenuPrincipalAnimado.this.dispose();
            }
        });
        // Imprimir Factura:----------------------------------------------------
    ...
    private void initComponents() {
        ...
        jLabel3.setText("DESKTOP PANEL: ");
        jLabel3.setBounds(10, 0, 170, 17);
        jDesktopPanel1.add(jLabel3, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(28, 28, 28)
                .addComponent(jDesktopPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 306, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new FrameMenuPrincipalAnimado().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(FrameMenuPrincipalAnimado.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
