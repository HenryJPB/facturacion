...
import bean.controlador.ControladorReportes;
...
public class FrameMenuPrincipal extends javax.swing.JFrame {
    ...
    ControladorPostearFactura controladorPostearFactura = new ControladorPostearFactura();  
    ...
    private void actualizarMenu() {
        ...
        this.jMenuItemPostearFactura.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                desactivarPaneles();
                activarPanel(panelPostearFactura);
        ...
        this.jMenuItemSalir.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                System.exit(0);// Cancelar todos los SRP (Programas colgados o Stay Resident Programs ). 
            }
        });
        // Imprimir Factura:----------------------------------------------------
    ...
    private void agregarPaneles() {
        // Portada. 
        panelPortada.setSize(xWindow - 1, yWindow - 1);
        this.jLayeredPaneMenuPrincipal.add(panelPortada);
        // (Opcion: Postear Factura).   
        panelPostearFactura.setSize(xWindow - 1, yWindow - 1);
        panelPostearFactura.setVisible(Boolean.FALSE);
        this.jLayeredPaneMenuPrincipal.add(panelPostearFactura);
        //  (Opcion) - Consultar: Prueba ===Eliminame===
        //panelPrueba.setSize(xWindow - 1, yWindow - 1);
        //panelPrueba.setVisible(Boolean.FALSE);
        //this.jLayeredPaneMenuPrincipal.add(panelPrueba); 
        //
        /*
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    private void desactivarPanel(JPanel panel) {
    ...
    private void desactivarPaneles() {
        ...
        panelPostearFactura.setVisible(false);
    }  // desactivarPaneles().

    //--------------------------------------------------------------------------    
    private void ejecutarFireworks() throws Exception {
        System.out.println("*****************************ejecutarFirewors*************************");
        /*  
         Fireworks_old fw = new Fireworks_old(); 
         new Thread((Runnable) fw).start();       // ???
         new Fireworks_old().start(new Stage());      // ???
         */
        /*
         ...
         */
        //Fireworks_old fireworks = new Fireworks_old();
        //fireworks.setVisible();
        Fireworks fireWorks = new Fireworks();
        fireWorks.startUp();
        System.out.println("**********FireWorks ejecutado******");
    }  // ejecutarFireworks(). ********
    ...
    /*
    private void prueba() {
      //this.jLayeredPaneMenuPrincipal.setRo 
      desactivarPaneles();
      activarPanel(panelPrueba);
    }  // prueba.
    */
    ...
    private void initComponents() {
        ...
        lblRelax = new javax.swing.JLabel();
        ...
        jLayeredPaneMenuPrincipal = new javax.swing.JLayeredPane();
        ...
        jDesktopPane1.add(lblMenuPrincipal);
        lblMenuPrincipal.setBounds(670, 20, 180, 31);
        ...
        jDesktopPane1.add(lblHome);
        lblHome.setBounds(680, 60, 40, 30);
        ...
        jDesktopPane1.add(lblDesconectar);
        lblDesconectar.setBounds(800, 60, 30, 30);

        lblRelax.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bean/utilitario/imagenes/relaxIcon32px.png"))); // NOI18N
        lblRelax.setToolTipText("Ir a la Pag. Principal. ");
        lblRelax.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblRelaxMouseClicked(evt);
            }
        });
        jDesktopPane1.add(lblRelax);
        lblRelax.setBounds(740, 60, 40, 30);
        ...
        jMenuConsulta.add(jMenuItemPrueba);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jLayeredPaneMenuPrincipal))
                        .addContainerGap())))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLayeredPaneMenuPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 557, Short.MAX_VALUE))
        );
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
      if ( panelPostearFactura.isVisible()) {
             controladorPostearFactura.agregarRegistro();
         } 
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (panelPostearFactura.isVisible() ) {
            controladorPostearFactura.editarRegistro();
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if ( panelPostearFactura.isVisible()) {
           controladorPostearFactura.eliminarRegistro(); 
        }
    ...
    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        if ( panelPostearFactura.isVisible()) {
             controladorPostearFactura.limpiarCampos();
         } 
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        if ( panelPostearFactura.isVisible()) {
            controladorPostearFactura.cancelar();
         }
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if ( panelPostearFactura.isVisible()) {
             controladorPostearFactura.actualizarRegistro(); 
        }
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        if ( panelPostearFactura.isVisible() ) {
         ControladorReportes controladorReporte = new ControladorReportes();  
         controladorReporte.ejecutarReporteFactura();
        }  // if.       
    ...
    private void lblHomeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblHomeMouseClicked
        /*
         this.jLayeredPaneMenuPrincipal.removeAll();   // ????. 
         this.jLayeredPaneMenuPrincipal.updateUI();
         */
        desactivarPaneles();
        activarPanel(panelPortada);
    }//GEN-LAST:event_lblHomeMouseClicked

    private void lblRelaxMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblRelaxMouseClicked
        try {
            ejecutarFireworks();
            /*
             MiAplicacion mapi = new MiAplicacion(); 
             mapi.init();
    ...
    }//GEN-LAST:event_lblRelaxMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameMenuPrincipalOld.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLayeredPane jLayeredPaneMenuPrincipal;
    ...
    private javax.swing.JLabel lblRelax;
