 ...
 * @author henrypb
 */
public class FrameMenuPrincipalOld extends javax.swing.JFrame {
    ...
    private void actualizarMenu() {
        ...
        this.jMenuItemSalir.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                FrameMenuPrincipalOld.this.setVisible(false);
                FrameMenuPrincipalOld.this.dispose();
            }
        });
        // Imprimir Factura:----------------------------------------------------
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new FrameMenuPrincipalOld().setVisible(true);
            }
        });
    }
